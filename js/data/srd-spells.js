...
export const SRD_SPELLS = [
    ...
    },
    {
        ...
        description: 'You touch a creature, and that creature must succeed on a Wisdom saving throw or become cursed for the duration of the spell. When you cast this spell, choose the nature of the curse from several options, such as disadvantage on ability checks and saving throws with one ability score, or dealing an extra 1d8 necrotic damage on your attacks against the target.',
        atHigherLevels: 'If you cast this spell using a spell slot of 4th level or higher, the duration is concentration, up to 10 minutes. At 5th level or higher, 8 hours (no concentration). At 7th level or higher, 24 hours (no concentration). At 9th level, permanent (no concentration).',
    },
    {
        name: 'Call Lightning',
        level: 3,
    ...
    },
    {
        ...
        description: 'You create an invisible sensor within range in a location familiar to you (a place you have visited or seen before) or in an obvious location that is unfamiliar to you. The sensor remains for the duration, and it can\'t be attacked or otherwise interacted with. You choose seeing or hearing when you cast this spell. You can use the chosen sense through the sensor as if you were in its space.',
        atHigherLevels: null,
    },
    {
    ...
    },
    {
        ...
        ritual: false,
        classes: ['Sorcerer', 'Warlock', 'Wizard'],
        description: 'You transform a willing creature you touch, along with everything it\'s wearing and carrying, into a misty cloud for the duration. The spell ends if the creature drops to 0 hit points. The creature has a flying speed of 10 feet, resistance to nonmagical damage, and advantage on Strength, Dexterity, and Constitution saving throws. The target can pass through small holes and narrow openings.',
        atHigherLevels: null,
    },
    {
        name: 'Magic Circle',
    ...
    },
    {
        ...
        ritual: false,
        classes: ['Bard', 'Sorcerer', 'Warlock', 'Wizard'],
        description: 'You create the image of an object, a creature, or some other visible phenomenon that is no larger than a 20-foot cube. The image appears at a spot that you can see within range and lasts for the duration. It seems completely real, including sounds, smells, and temperature appropriate to the thing depicted. You can\'t create sufficient heat or cold to cause damage, a sound loud enough to deal thunder damage, or a smell that might sicken a creature.',
    ...
    },
    {
        ...
        ritual: false,
        classes: ['Bard', 'Druid', 'Ranger'],
        description: 'This spell channels vitality into plants within a specific area. There are two possible uses for the spell. If you cast this spell using 1 action, choose a point within range. All normal plants in a 100-foot radius centered on that point become thick and overgrown, and a creature moving through the area must spend 4 feet of movement for every 1 foot it moves. If you cast this spell over 8 hours, you enrich the land and all plants in a half-mile radius yield twice the normal amount of food when harvested for 1 year.',
        atHigherLevels: null,
    },
    {
    ...
    },
    {
        ...
        description: 'Until the spell ends, you control any freestanding water inside an area you choose that is a cube up to 100 feet on a side. You can choose from several effects when you cast this spell: Flood, Part Water, Redirect Flow, or Whirlpool. As an action on your turn, you can repeat the same effect or choose a different one.',
        atHigherLevels: null,
    },
    {
        name: 'Death Ward',
    ...
    },
    {
        ...
        ritual: true,
        classes: ['Cleric'],
        description: 'Your magic and an offering put you in contact with a god or a god\'s servants. You ask a single question concerning a specific goal, event, or activity to occur within 7 days. The DM offers a truthful reply, which might be a short phrase, a cryptic rhyme, or an omen. The spell doesn\'t take into account any possible circumstances that might change the outcome.',
        atHigherLevels: null,
    },
    {
        name: 'Dominate Beast',
        ...
        atHigherLevels: 'When you cast this spell with a 5th-level spell slot, the duration is concentration, up to 10 minutes. At 6th level, up to 1 hour. At 7th level or higher, up to 8 hours.',
    },
    {
        name: 'Fabricate',
        level: 4,
    ...
    },
    {
        ...
        ritual: false,
        classes: ['Wizard'],
        description: 'Thin and wispy flames wreathe your body for the duration, shedding bright light in a 10-foot radius and dim light for an additional 10 feet. You can end the spell early by using an action to dismiss it. The flames provide you with a warm shield or a chill shield, as you choose. The warm shield grants you resistance to cold damage, and the chill shield grants you resistance to fire damage. Whenever a creature within 5 feet of you hits you with a melee attack, the shield erupts with flame, dealing 2d8 fire damage (warm) or 2d8 cold damage (chill) to the attacker.',
        atHigherLevels: null,
    },
    {
    ...
    },
    {
        ...
        ritual: false,
        classes: ['Druid'],
        description: 'You transform up to ten centipedes, three spiders, five wasps, or one scorpion within range into giant versions of their natural forms for the duration. The creatures are friendly to you and your companions. In combat, the creatures share your initiative count, but take their turns immediately after yours.',
        atHigherLevels: null,
    },
    {
    ...
    },
    {
        ...
        description: 'You make natural terrain in a 150-foot cube in range look, sound, and smell like some other sort of natural terrain. Thus, open fields or a road can be made to resemble a swamp, hill, crevasse, or some other difficult or impassable terrain. A pond can be made to seem like a grassy meadow. Manufactured structures, equipment, and creatures within the area aren\'t changed in appearance.',
        atHigherLevels: null,
    },
    {
    ...
    },
    {
        ...
        description: 'You mentally contact a demigod, the spirit of a long-dead sage, or some other mysterious entity from another plane. Contacting this extraplanar intelligence can strain or even break your mind. When you cast this spell, make a DC 15 Intelligence saving throw. On a failure, you take 6d6 psychic damage and are insane until you finish a long rest. On a success, you can ask the entity up to five questions and receive truthful, short answers.',
        atHigherLevels: null,
    },
    {
        ...
        atHigherLevels: 'When you cast this spell using a 6th-level spell slot, the duration is concentration, up to 10 minutes. At 7th level, up to 1 hour. At 8th level or higher, up to 8 hours.',
    },
    {
        name: 'Dream',
        level: 5,
        ...
        ritual: false,
        classes: ['Bard', 'Warlock', 'Wizard'],
        description: 'This spell shapes a creature\'s dreams. You or a willing creature you touch enters a trance state, acting as a messenger. While in the trance, the messenger is aware of its surroundings but can\'t take actions or move. If the target is asleep, the messenger appears in the target\'s dreams and can converse with the target as long as it remains asleep, through the duration of the spell. The messenger can also shape the environment of the dream.',
        atHigherLevels: null,
    },
    {
        name: 'Flame Strike',
    ...
    },
    {
        ...
        atHigherLevels: 'When you cast this spell using a spell slot of a higher level, the duration increases: 6th (10 days), 7th (30 days), 8th (180 days), 9th (a year and a day).',
    },
    {
        name: 'Scrying',
        level: 5,
        ...
        description: 'You can see and hear a particular creature you choose that is on the same plane of existence as you. The target must make a Wisdom saving throw, which is modified by how well you know the target and the sort of physical connection you have to it. On a successful save, the target isn\'t affected, and you can\'t use this spell against it again for 24 hours. On a failed save, the spell creates an invisible sensor within 10 feet of the target.',
        atHigherLevels: null,
    },
    {
        name: 'Seeming',
    ...
    },
    {
        ...
        ritual: false,
        classes: ['Bard', 'Sorcerer', 'Wizard'],
        description: 'As you cast the spell, you draw a 10-foot-diameter circle on the ground inscribed with sigils that link your location to a permanent teleportation circle of your choice whose sigil sequence you know and that is on the same plane of existence as you. A shimmering portal opens within the circle you drew and remains open until the end of your next turn. Any creature that enters the portal instantly appears within 5 feet of the destination circle.',
        atHigherLevels: null,
    },
    {
        name: 'Tree Stride',
        ...
        ritual: false,
        classes: ['Druid', 'Ranger'],
        description: 'You gain the ability to enter a tree and move from inside it to inside another tree of the same kind within 500 feet. Both trees must be living and at least the same size as you. You must use 5 feet of movement to step into the tree. You instantly know the location of all other trees of the same kind within 500 feet and, as part of the move used to enter the tree, can either pass into one of those trees or step out of the tree you\'re in.',
        atHigherLevels: null,
    },
    {
        name: 'Wall of Stone',
    ...
    },
    {
        ...
        ritual: false,
        classes: ['Bard', 'Wizard'],
        description: 'Choose one creature that you can see within range. The target begins a comic dance in place: shuffling, tapping its feet, and capering for the duration. Creatures that can\'t be charmed are immune to this spell. A dancing creature must use all its movement to dance without leaving its space and has disadvantage on Dexterity saving throws and attack rolls. While the target is affected by this spell, other creatures have advantage on attack rolls against it. A dancing creature can use its action to make a Wisdom saving throw to end the effect.',
        atHigherLevels: null,
    },
    {
        name: 'Planar Ally',
    ...
    },
    {
        ...
        ritual: false,
        classes: ['Wizard'],
        description: 'You create a wall of ice on a solid surface within range. You can form it into a hemispherical dome or a sphere with a radius of up to 10 feet, or you can shape a flat surface made up of ten 10-foot-square panels. Each panel must be contiguous with another panel. The wall is 1 foot thick and lasts for the duration. If the wall cuts through a creature\'s space when it appears, the creature within its area is pushed to one side of the wall and must make a Dexterity saving throw. On a failed save, the creature takes 10d6 cold damage, or half as much on a successful save.',
        atHigherLevels: 'When you cast this spell using a spell slot of 7th level or higher, the damage the wall deals when it appears increases by 2d6 for each slot level above 6th.',
    },
    {
        name: 'Wind Walk',
        level: 6,
    ...
    },
    {
        ...
        ritual: false,
        classes: ['Cleric'],
        description: 'You summon a celestial of challenge rating 4 or lower, which appears in an unoccupied space that you can see within range. The celestial disappears when it drops to 0 hit points or when the spell ends. The celestial is friendly to you and your companions for the duration. In combat, the creature shares your initiative count, but it takes its turn immediately after yours.',
    ...
    },
    {
        ...
        ritual: false,
        classes: ['Bard', 'Cleric', 'Sorcerer', 'Warlock', 'Wizard'],
        description: 'You step into the border regions of the Ethereal Plane, in the area where it overlaps with your current plane. You remain in the Border Ethereal for the duration or until you use your action to dismiss the spell. During this time, you can move in any direction. If you move up or down, every foot of movement costs an extra foot. You can see and hear the plane you originated from, but everything there looks gray, and you can\'t see anything more than 60 feet away. You are invisible and can\'t affect or be affected by anything on the other plane.',
        atHigherLevels: 'When you cast this spell using a spell slot of 8th level or higher, you can target up to three willing creatures (including you) for each slot level above 7th.',
    },
    {
        name: 'Fire Storm',
        level: 7,
    ...
    },
    {
        ...
        ritual: false,
        classes: ['Wizard'],
        description: 'By means of this spell, a willing creature or an object can be hidden away, safe from detection for the duration. When you cast the spell and touch the target, it becomes invisible and can\'t be targeted by divination spells or perceived through scrying sensors created by divination spells. If the target is a creature, it falls into a state of suspended animation. Time ceases to flow for it, and it doesn\'t age. You can set a condition for the spell to end early.',
        atHigherLevels: null,
    },
    {
        name: 'Simulacrum',
    ...
    },
    {
        ...
        ritual: false,
        classes: ['Bard', 'Cleric', 'Wizard'],
        description: 'When you cast this spell, you inscribe a harmful glyph either on a surface or within an object that can be closed to conceal the glyph. The glyph can cover an area no larger than 10 feet in diameter. When triggered, the glyph erupts and fills a 60-foot-radius sphere with a chosen effect: Death, Discord, Fear, Hopelessness, Insanity, Pain, Sleep, or Stunning. Each effect requires targets to make a saving throw or be affected for the duration.',
        atHigherLevels: null,
    },
    ...
    },
    {
        ...
        ritual: false,
        classes: ['Wizard'],
        description: 'This spell grows an inert duplicate of a living creature as a safeguard against death. This clone forms inside a sealed vessel and grows to full size and maturity after 120 days; you can also choose to have the clone be a younger version of the same creature. It remains inert and endures indefinitely, as long as its vessel remains undisturbed. At any time after the clone matures, if the original creature dies, its soul transfers to the clone.',
        atHigherLevels: null,
    },
    {
    ...
    },
    {
        ...
        ritual: false,
        classes: ['Druid'],
        description: 'A wall of water springs into existence at a point you choose within range. You can make the wall up to 300 feet long, 300 feet high, and 50 feet thick. The wall lasts for the duration. When the wall appears, each creature within its area must make a Strength saving throw. On a failed save, a creature takes 6d10 bludgeoning damage, or half as much on a success. At the start of each of your turns after the wall appears, the wall, along with any creatures in it, moves 50 feet away from you. Each creature inside the wall or whose space the wall enters when it moves must make a Strength saving throw.',
        atHigherLevels: null,
    },
    ...
    },
    {
        ...
        ritual: false,
        classes: ['Wizard'],
        description: 'A shimmering, multicolored plane of light forms a vertical opaque wall, up to 90 feet long, 30 feet high, and 1 inch thick, centered on a point you can see within range. Alternatively, you can shape the wall into a sphere up to 30 feet in diameter centered on a point you choose within range. The wall sheds bright light out to a range of 100 feet and dim light for an additional 100 feet. The wall consists of seven layers, each with a different color: red, orange, yellow, green, blue, indigo, and violet. Each layer has a different effect on creatures that attempt to pass through it.',
        atHigherLevels: null,
    },
    {
        name: 'Shapechange',
        ...
        ritual: false,
        classes: ['Druid', 'Wizard'],
        description: 'You assume the form of a different creature for the duration. The new form can be of any creature with a challenge rating equal to your level or lower. The creature can\'t be a construct or an undead. You retain your alignment, personality, Intelligence, Wisdom, and Charisma scores. You also retain all of your skill and saving throw proficiencies. You assume the hit points and Hit Dice of the new form. You can change forms as an action during the duration.',
        atHigherLevels: null,
    },
    {
        ...
        ritual: false,
        classes: ['Druid'],
        description: 'A churning storm cloud forms, centered on a point you can see and spreading to a radius of 360 feet. Lightning flashes in the area, thunder booms, and strong winds roar. Each creature under the cloud when it appears must make a Constitution saving throw. On a failed save, a creature takes 2d6 thunder damage and becomes deafened for 5 minutes. Each round you maintain concentration, the storm produces additional effects on your turn: acid rain, lightning bolts, hailstones, and more.',
        atHigherLevels: null,
    },
    {
        name: 'Weird',
